            ...
            {activeTab === 3 && (
              <div className="tab-section active">
                <div className="card-section investigacion-section">
                  ...
                  {/* SECCIONES DE INVESTIGACIÓN RECABADA - DESPUÉS DE TESTIGOS */}
                  <div
                    style={{
                      marginTop: "50px",
                      padding: "30px",
                  ...
                  >
                    ...
                    >
                      Complete todas las secciones siguientes para completar la
                          ...
                          <div className="dynamic-item-header">
                            ...
                            <button
                              ...
                              onClick={() => {
                                ...
                                setFormData((prev) => ({
                                  ...prev,
                                  observaciones: currentObservaciones.filter(
                                    (_, i) => i !== index
                                  ),
                                }));
                              }}
                        ...
                        <div className="dynamic-item-header">
                          ...
                          <button
                            ...
                            onClick={() => {
                              ...
                              setFormData((prev) => ({
                                ...prev,
                                conclusiones: currentConclusiones.filter(
                                  (_, i) => i !== index
                                ),
                              }));
                            }}
